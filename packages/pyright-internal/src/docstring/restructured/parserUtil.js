...
// @ts-nocheck
// This file is copied from https://raw.githubusercontent.com/seikichi/restructured/master/src/ParserUtil.js
...
const PunctuationStartStringPrefix = new RegExp(`\\s|[${PunctuationOpeners}${PunctuationDelimiters}]`);

const PunctuationEndStringSuffix = new RegExp(
    `\\s|[${PunctuationClosingDelimiters}` + `${PunctuationDelimiters}${PunctuationClosers}]`
);
...
const ParserUtil = {
    ...
    isMatchPunctuations(c1, c2) {
        return (
            PunctuationOpenerToCloser[c1] === c2 ||
